...
public class TeacherController {
    ...
    public ResponseEntity<TeacherCreationDto> update(@PathVariable("id") Long id,@RequestBody TeacherCreationDto teacher) {
    Optional<Teacher> optionalTeacher = teacherService.find(id);
